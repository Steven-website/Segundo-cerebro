...
SCHEMAS = {
    ...
    "tareas": {"id": str, "titulo": str, "area": str, "prioridad": str, "fecha_inicio": str, "fecha": str, "fecha_completada": str, "proyecto": str, "notas": str, "subtareas": str, "recurrente": str, "depende_de": str, "etiqueta": str, "done": bool, "pinned": bool, "archived": bool, "ts": float},
    ...
    "debt_monthly": {"id": str, "debt_id": str, "periodo": str, "saldo": float, "pago": float, "ts": float},
    ...
    "exercise_log": {"id": str, "fecha": str, "deporte": str, "duracion": int, "notas": str, "ts": float},
}
